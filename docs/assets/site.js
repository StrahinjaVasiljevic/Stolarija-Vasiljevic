  ...
  const UI = {
    sr: {
      ...
      contact: {
        ...
        phone: "Telefon",
        email: "Email",
        area: "Područje — Novi Sad, Beograd i okolina",
        hint: "Upit šaljite mejlom ili ovde",
        ...
        deadline: "Rok",
        budget: "Budžet",
        images: "Slike — max 10 — do 5MB po slici",
    ...
    en: {
      ...
      contact: {
        ...
        deadline: "Deadline",
        budget: "Budget",
        images: "Images — max 10 — up to 5MB each",
